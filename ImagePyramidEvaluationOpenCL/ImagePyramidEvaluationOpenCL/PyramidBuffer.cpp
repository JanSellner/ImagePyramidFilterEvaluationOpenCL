...
void PyramidBuffer::init()
{
    try
    {
        ...
        programFilter = cl::Program(opencl.getContext(), AKernel<KernelFilterBuffer>::kernelSource());
...
void PyramidBuffer::createPyramid()
{
    ...
    // Images
    images = cl::Buffer(opencl.getContext(), CL_MEM_READ_WRITE, sizeof(float) * totalPixels);
