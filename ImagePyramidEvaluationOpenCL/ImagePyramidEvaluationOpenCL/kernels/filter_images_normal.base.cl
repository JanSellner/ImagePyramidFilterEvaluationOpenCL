 ...
 */
/* GENERATE_TYPE */ filter_sum_MULTIPLICITY_DERIV_NxN(read_only image2d_t imgIn/* GENERATE_REMOVE_PREDEFINED:,
 ...
 */
kernel void filter_MULTIPLICITY_DERIV_NxN(read_only image2d_t imgIn,
