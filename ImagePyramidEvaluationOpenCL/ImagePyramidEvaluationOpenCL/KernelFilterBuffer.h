...
public:
    ...
    cl::Event runSingle(cl::Buffer& imgSrc, cl::Buffer& imgDst, cl::Buffer& locationLookup, int octave, const std::vector<Lookup>& lookup);
    cl::Event runSingleLocal(cl::Buffer& imgSrc, cl::Buffer& imgDst, cl::Buffer& locationLookup, int octave, const std::vector<Lookup>& lookup);
    cl::Event runSingleSeparationLocal(cl::Buffer& imgSrc, cl::Buffer& imgDst, cl::Buffer& locationLookup, int octave, const std::vector<Lookup>& lookup);
